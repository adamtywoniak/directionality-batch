/* //package fiji.analyze.batchdirectionality;
//from "package ij.plugin.frame;" to "import ij.plugin.frame.*" */
 ...
 * @version 2.0
 */
public class BatchDirectionality_ implements PlugIn
{
	...
	private static final String PLUGIN_NAME = "Batch Directionality analysis";
	...
	public void run( final String arg )
	{
		...
		if ( null == imp )
		{
			IJ.error( "Batch Directionality", "No images are open." );
			return;
		}
		...
		if ( null != arg && arg.length() > 0 )
		{
			...
			if ( null != str )
			{
				...
				{
					IJ.error( "Batch Directionality: bad argument for number of bins: " + str );
					return;
				}
			}
			...
			if ( null != str )
			{
				...
				{
					IJ.error( "Batch Directionality: bad argument for start point: " + str );
					return;
				}
			}
...
//		double[] dir = new double[nbins]; // histo with #bins
	...
	public static void main( final String[] args )
	{
		...
		final BatchDirectionality_ da = new BatchDirectionality_();
		da.setImagePlus( imp );
